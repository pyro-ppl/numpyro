# Code taken from https://github.com/google/edward2/tree/master/examples/no_u_turn_sampler
# with modifications at lines 209, 454, 462, 463
# to set max_tree_depth to 10 and record the number of leapfrog steps.
...
def kernel(target_log_prob_fn,
  ...
  with tf.name_scope(name):
    ...
    while continue_trajectory:
      ...
      continue_trajectory = continue_trajectory and has_no_u_turn and (depth < 9)
