...
setup(
    ...
    extras_require={"doc": ["nbsphinx", "sphinx", "sphinx_rtd_theme", "sphinx-gallery"], "test": ["flake8", "ipython", "pytest>=4.1", "pyro-api>=0.1.1", "scipy>=1.1"], "dev": ["dm-haiku", "flax", "funsor @ git+https://github.com/pyro-ppl/funsor.git@d5574988665dd822ec64e41f2b54b9dc929959dc", "ipython", "isort", "tensorflow_probability", "graphviz"], "examples": ["matplotlib", "seaborn", "arviz"]},
