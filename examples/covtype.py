...
def benchmark_hmc(args, features, labels):
    ...
    if args.algo == "HMC":
        ...
        subsample_size = 1000
        inner_kernel = NUTS(model, init_strategy=init_to_value(values=ref_params), dense_mass=args.dense_mass)
        ...
        inner_kernel = NUTS(neutra_model, init_strategy=init_to_value(values=neutra_ref_params), adapt_mass_matrix=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algo", default="HMCECS", type=str, help='whether to run "HMC", "NUTS", "HMCECS", "SA" or "FlowHMCECS"')
