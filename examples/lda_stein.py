...
def lda(docs, num_words, num_topics, num_hidden=100, subsample_size=10):
    ...
    with numpyro.plate('documents', docs.shape[1], subsample_size=subsample_size, dim=-1):
        ...
        with numpyro.plate('words', num_words, dim=-2):
            ...
            numpyro.sample('word_count', dist.Categorical(probs=topic_words[word_topics]), obs=batch_docs)
