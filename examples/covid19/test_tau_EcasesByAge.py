...
if __name__ == '__main__':
    ...
    for test in range(NUM_TESTS):
        ...
        school_switch = school_switch[N0:]
        tau = 3
        ...
        print("value_direct",value_direct.shape, "\n")

        impact_intv = impact_intv[N0:]

        wkend_idx_local = wkend_idx_local[N0:]
