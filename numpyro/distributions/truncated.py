...
def TruncatedDistribution(base_dist, low=None, high=None, *, validate_args=None):
    ...
    :param base_dist: The base distribution to be truncated. This should be a
...
class LowerTruncatedPowerLaw(Distribution):
    r"""Lower truncated power law distribution with :math:`\alpha` index. We can
    define the power law distribution as,
