...
def flax_module(
    ...
    """Declare a :mod:`~flax` style neural network inside a model so that its
    parameters are registered for optimization via :func:`~numpyro.primitives.param`
    statements.
...
def haiku_module(name, nn_module, *args, input_shape=None, apply_rng=False, **kwargs):
    """Declare a :mod:`~haiku` style neural network inside a model so that its
    parameters are registered for optimization via :func:`~numpyro.primitives.param`
    statements.
...
def random_flax_module(
    ...
    **kwargs,
    ...
    """A primitive to place a prior over the parameters of the Flax module
    `nn_module`.
...
def random_haiku_module(
    ...
    """A primitive to place a prior over the parameters of the Haiku module
    `nn_module`.
