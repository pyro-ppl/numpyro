...
def uniform_reparam_transform(d):
    """A helper for :class:`UniformReparam` to get the transform that transforms a
...
class NestedSampler:
    ...
    **References**
    ...
    def get_samples(self, rng_key, num_samples, *, group_by_chain=False):
        ...
        :param random.PRNGKey rng_key: Random number generator key to be used to
            draw samples.
        :param int num_samples: The number of samples.
        :param bool group_by_chain: If True, a leading chain dimension of 1 is added
