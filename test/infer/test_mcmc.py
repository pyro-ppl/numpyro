...
from numpyro.infer import HMC, MCMC, NUTS, SA, BarkerMH, AIES, ESS # TODO: get ESS working 
...
@pytest.mark.parametrize("kernel_cls", [HMC, NUTS, SA, BarkerMH, AIES])
